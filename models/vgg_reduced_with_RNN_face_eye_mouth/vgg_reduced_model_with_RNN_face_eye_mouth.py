...
import torch
import data_preprocessing_face_eye_mouth
...
if __name__ == '__main__':
    ...
    my_data, my_label = data_preprocessing_face_eye_mouth.get_all_data(TRAIN_VAL_DIR, TIME_STEP)
    train_data, train_label, val_data, val_label = train_val_split(my_data, my_label)
    del my_data
    del my_label

    # get the testing data
    test_data, test_label = data_preprocessing_face_eye_mouth.get_all_data(TEST_DIR, TIME_STEP)
