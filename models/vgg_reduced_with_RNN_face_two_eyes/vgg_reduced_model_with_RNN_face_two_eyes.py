...
HISTORY_DIR = "vgg_reduced_model_with_RNN_face_two_eyes_history/"
...
class CompoundModel(nn.Module):
    ...
    def forward(self, x):
        ...
        r_in = torch.cat((face_out, region1_out, region2_out), 1)
...
if __name__ == '__main__':
    ...
    val_comparison_plot = plt.scatter(val_label, val_prediction, c='blue', alpha=0.6, label='Prediction vs Ground Truth')
    ...
    val_error_plot3 = plt.plot([0.0, 11.0], [2.0, 13.0], c='y', label='y=x+2', linestyle="-")
    val_error_plot4 = plt.plot([0.0, 11.0], [-2.0, 9.0], c='y', label='y=x-2', linestyle="-")
