...
import torch
import data_preprocessing_face_two_eyes_mouth_mouth
...
history_dir = 'vgg_reduced_face_two_eyes_mouth_training_history_RMSE/'
...
class CompoundModel(nn.Module):
    ...
    def forward(self, x):
        ...
        mouth_in = mouth.view(batch_size * time_step, C, H, W)
        ...
        mouth_out = self.cnn_mouth(mouth_in)
        ...
        r_in = torch.cat((face_out, left_eye_out, right_eye_out, mouth_out), 1)
...
if __name__ == '__main__':
    ...
    my_data, my_label = data_preprocessing_face_two_eyes_mouth.get_all_data(main_dir)
    val_data, val_label = data_preprocessing_face_two_eyes_mouth.get_all_data(val_dir)
    ...
    f = open(history_dir + 'vgg_reduced_face_two_eyes_mouth_model_training_history_BatchSize=' + str(BATCH_SIZE) + '_Epoch=' + str(EPOCH) + '.txt', 'w+')
    ...
    name = 'vgg_reduced_face_two_eyes_mouth_model_training_history_BatchSize=' + str(BATCH_SIZE) + '_Epoch=' + str(EPOCH) 
    plt.title(name)
